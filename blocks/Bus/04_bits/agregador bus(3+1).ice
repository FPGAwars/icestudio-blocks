  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "20ef1122-19c4-49a6-bc98-23db8290b008",
          "type": "basic.output",
          "data": {
            "name": "o",
            "range": "[3:0]",
        ...
        {
          "id": "7a4690f1-72a3-48fd-b3c9-eaba3dd47294",
          "type": "basic.input",
          "data": {
            "name": "i0",
            "range": "[0:0]",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "<h1>Agregador buses(3+1)<h1>",
            "readonly": true
          },
          "position": {
            "x": 384,
      ...
      "wires": [
        {
          "source": {
            "block": "7a4690f1-72a3-48fd-b3c9-eaba3dd47294",
            "port": "out"
          },
          "target": {
        ...
        },
        {
          ...
          "target": {
            "block": "20ef1122-19c4-49a6-bc98-23db8290b008",
            "port": "in"
          },
          "size": 4
        }
