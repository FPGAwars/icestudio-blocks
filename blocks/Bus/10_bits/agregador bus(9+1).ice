{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "df9f61bb-5584-4140-8828-fe2bc65a1732",
          "type": "basic.input",
          "data": {
            "name": "i1",
            "range": "[8:0]",
        ...
        {
          "id": "797d4053-13dc-4df0-b3c5-285ea5f1cdcc",
          "type": "basic.output",
          "data": {
            "name": "o",
            "range": "[9:0]",
        ...
        {
          "id": "908819a2-9ae1-4df0-9800-c4a08700f9e5",
          "type": "basic.input",
          "data": {
            "name": "i0",
            "range": "[0:0]",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "<h1>Agregador buses(9+1)<h1>",
            "readonly": true
          },
          "position": {
            "x": 416,
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "797d4053-13dc-4df0-b3c5-285ea5f1cdcc",
            "port": "in"
          },
          "size": 10
        },
        {
          "source": {
            "block": "908819a2-9ae1-4df0-9800-c4a08700f9e5",
            "port": "out"
          },
          "target": {
            "block": "557af22b-775a-490b-b94f-567c59ab4aed",
        ...
        {
          "source": {
            "block": "df9f61bb-5584-4140-8828-fe2bc65a1732",
            "port": "out"
          },
          "target": {
            "block": "557af22b-775a-490b-b94f-567c59ab4aed",
