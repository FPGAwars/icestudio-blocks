{
  "version": "1.2",
  "package": {
    "name": "separador bus(7+3)",
    "version": "0.1",
    "description": "Separador bus(7+3)",
    "author": "gut-mart",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "85470259-d5a2-46eb-8ceb-a08aa4172094",
          "type": "basic.input",
          "data": {
            "name": "i",
            "range": "[9:0]",
        ...
        {
          "id": "30fa7029-98ec-48f1-bb96-fa7c99a8f6c9",
          "type": "basic.output",
          "data": {
            "name": "o0",
            "range": "[2:0]",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "30fa7029-98ec-48f1-bb96-fa7c99a8f6c9",
            "port": "in"
          },
          "size": 3
        },
        {
          "source": {
            "block": "85470259-d5a2-46eb-8ceb-a08aa4172094",
            "port": "out"
          },
          "target": {
            "block": "dcd8567f-2ff9-4aac-946b-b898f723fd43",
