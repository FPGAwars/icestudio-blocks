  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "1d20ea4b-cd06-4318-8540-ec0a0704a001",
          "type": "basic.input",
          "data": {
            "name": "i",
            "range": "[9:0]",
        ...
        {
          "id": "c2278457-2e4e-4293-a042-3bc14159d2cc",
          "type": "basic.output",
          "data": {
            "name": "o0",
            "range": "[8:0]",
      ...
      "wires": [
        {
          "source": {
            "block": "1d20ea4b-cd06-4318-8540-ec0a0704a001",
            "port": "out"
          },
          "target": {
        ...
        },
        {
          ...
          "target": {
            "block": "c2278457-2e4e-4293-a042-3bc14159d2cc",
            "port": "in"
          },
          "size": 9
        }
