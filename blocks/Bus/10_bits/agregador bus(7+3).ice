{
  "version": "1.2",
  "package": {
    "name": "Agregador buses(7+3) bits",
    "version": "0.1",
    "description": "Agregador de buses de 7-bits y 3-bits a bus de 10-bits",
    "author": "gut-mart",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "e33769d8-7609-47a4-a615-30d76ca9b48e",
          "type": "basic.output",
          "data": {
            "name": "o",
            "range": "[9:0]",
        ...
        {
          "id": "b749c90a-2c87-49ff-a962-fa95283ecbd8",
          "type": "basic.input",
          "data": {
            "name": "i0",
            "range": "[2:0]",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "<h1>Agregador buses(7+3)<h1>",
            "readonly": true
          },
          "position": {
            "x": 416,
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "b749c90a-2c87-49ff-a962-fa95283ecbd8",
            "port": "out"
          },
          "target": {
            "block": "557af22b-775a-490b-b94f-567c59ab4aed",
        ...
        },
        {
          ...
          "target": {
            "block": "e33769d8-7609-47a4-a615-30d76ca9b48e",
            "port": "in"
          },
          "size": 10
        }
