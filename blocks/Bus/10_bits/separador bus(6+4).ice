{
  "version": "1.2",
  "package": {
    "name": "separador bus(6+4)",
    "version": "0.1",
    "description": "Separador bus(6+4)",
    "author": "gut-mart",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "aaa1902f-309f-493c-aff0-1030c9b4e1ec",
          "type": "basic.input",
          "data": {
            "name": "i",
            "range": "[9:0]",
        ...
        {
          "id": "c3c9c04d-f06a-4410-a226-0cc3aa77fffa",
          "type": "basic.output",
          "data": {
            "name": "o0",
            "range": "[3:0]",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "c3c9c04d-f06a-4410-a226-0cc3aa77fffa",
            "port": "in"
          },
          "size": 4
        },
        {
          "source": {
            "block": "aaa1902f-309f-493c-aff0-1030c9b4e1ec",
            "port": "out"
          },
          "target": {
            "block": "dcd8567f-2ff9-4aac-946b-b898f723fd43",
