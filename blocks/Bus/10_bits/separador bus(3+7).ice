{
  "version": "1.2",
  "package": {
    "name": "separador bus(3+7)",
    "version": "0.1",
    "description": "Separador bus(3+7)",
    "author": "gut-mart",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "5f71ea63-6c49-42cd-8b5b-e8f77427ecbc",
          "type": "basic.input",
          "data": {
            "name": "i",
            "range": "[9:0]",
        ...
        {
          "id": "b933ed12-afa8-4894-adfd-10dda83f1014",
          "type": "basic.output",
          "data": {
            "name": "o0",
            "range": "[6:0]",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "b933ed12-afa8-4894-adfd-10dda83f1014",
            "port": "in"
          },
          "size": 7
        },
        {
          "source": {
            "block": "5f71ea63-6c49-42cd-8b5b-e8f77427ecbc",
            "port": "out"
          },
          "target": {
            "block": "dcd8567f-2ff9-4aac-946b-b898f723fd43",
