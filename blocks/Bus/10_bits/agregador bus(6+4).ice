{
  "version": "1.2",
  "package": {
    "name": "Agregador buses(6+4) bits",
    "version": "0.1",
    "description": "Agregador de buses de 6-bits y 4-bits a bus de 10-bits",
    "author": "gut-mart",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "daac0e22-f5c6-463f-bcca-609468558ffd",
          "type": "basic.output",
          "data": {
            "name": "o",
            "range": "[9:0]",
        ...
        {
          "id": "eda80e63-2e14-48ed-b1bb-54a32d283ff7",
          "type": "basic.input",
          "data": {
            "name": "i0",
            "range": "[3:0]",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "<h1>Agregador buses(6+4)<h1>",
            "readonly": true
          },
          "position": {
            "x": 416,
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "eda80e63-2e14-48ed-b1bb-54a32d283ff7",
            "port": "out"
          },
          "target": {
            "block": "557af22b-775a-490b-b94f-567c59ab4aed",
        ...
        },
        {
          ...
          "target": {
            "block": "daac0e22-f5c6-463f-bcca-609468558ffd",
            "port": "in"
          },
          "size": 10
        }
