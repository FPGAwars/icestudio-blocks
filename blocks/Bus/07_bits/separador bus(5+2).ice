{
  "version": "1.2",
  "package": {
    "name": "separador bus(5+2)",
    "version": "0.1",
    "description": "Separador bus(5+2)",
    "author": "gut-mart",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "c6ce7047-535f-4dbe-ad5b-81e926185d4d",
          "type": "basic.input",
          "data": {
            "name": "i",
            "range": "[6:0]",
        ...
        {
          "id": "982a5598-a7f3-4852-8a0f-1102a0ecf877",
          "type": "basic.output",
          "data": {
            "name": "o0",
            "range": "[1:0]",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "982a5598-a7f3-4852-8a0f-1102a0ecf877",
            "port": "in"
          },
          "size": 2
        },
        {
          "source": {
            "block": "c6ce7047-535f-4dbe-ad5b-81e926185d4d",
            "port": "out"
          },
          "target": {
            "block": "dcd8567f-2ff9-4aac-946b-b898f723fd43",
