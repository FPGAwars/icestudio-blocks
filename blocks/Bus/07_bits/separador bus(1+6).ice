{
  "version": "1.2",
  "package": {
    "name": "separador bus(1+6)",
    "version": "0.1",
    "description": "Separador bus(1+6)",
    "author": "gut-mart",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "a300c1a5-b723-40fc-8cd4-466a812bff32",
          "type": "basic.input",
          "data": {
            "name": "i",
            "range": "[6:0]",
        ...
        {
          "id": "e2f090cb-6b63-41f0-aafd-a3bb1f46625e",
          "type": "basic.output",
          "data": {
            "name": "o0",
            "range": "[5:0]",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "e2f090cb-6b63-41f0-aafd-a3bb1f46625e",
            "port": "in"
          },
          "size": 6
        },
        {
          "source": {
            "block": "a300c1a5-b723-40fc-8cd4-466a812bff32",
            "port": "out"
          },
          "target": {
            "block": "dcd8567f-2ff9-4aac-946b-b898f723fd43",
