{
  "version": "1.2",
  "package": {
    "name": "Agregador buses(6+1) bits",
    "version": "0.1",
    "description": "Agregador de buses de 6-bits y 1-bits a bus de 7-bits",
    "author": "gut-mart",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "c3d699d5-418d-455d-9f1c-c3e7cec40953",
          "type": "basic.output",
          "data": {
            "name": "o",
            "range": "[6:0]",
        ...
        {
          "id": "0dbe9a62-845b-4062-a6bd-a13249b8da7f",
          "type": "basic.input",
          "data": {
            "name": "i0",
            "range": "[0:0]",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "<h1>Agregador buses(6+1)<h1>",
            "readonly": true
          },
          "position": {
            "x": 416,
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "c3d699d5-418d-455d-9f1c-c3e7cec40953",
            "port": "in"
          },
          "size": 7
        },
        ...
        {
          "source": {
            "block": "0dbe9a62-845b-4062-a6bd-a13249b8da7f",
            "port": "out"
          },
          "target": {
            "block": "557af22b-775a-490b-b94f-567c59ab4aed",
