{
  "version": "1.2",
  "package": {
    "name": "Agregador buses(5+2) bits",
    "version": "0.1",
    "description": "Agregador de buses de 5-bits y 2-bits a bus de 7-bits",
    "author": "gut-mart",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "01c4ecdc-e537-486b-baaf-e4be33b9c3f2",
          "type": "basic.output",
          "data": {
            "name": "o",
            "range": "[6:0]",
        ...
        {
          "id": "01fb0acc-ae92-4943-abb8-ee30acf2ce6d",
          "type": "basic.input",
          "data": {
            "name": "i0",
            "range": "[1:0]",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "<h1>Agregador buses(5+2)<h1>",
            "readonly": true
          },
          "position": {
            "x": 416,
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "01fb0acc-ae92-4943-abb8-ee30acf2ce6d",
            "port": "out"
          },
          "target": {
            "block": "557af22b-775a-490b-b94f-567c59ab4aed",
