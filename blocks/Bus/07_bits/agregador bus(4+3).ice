{
  "version": "1.2",
  "package": {
    "name": "Agregador buses(4+3) bits",
    "version": "0.1",
    "description": "Agregador de buses de 4-bits y 3-bits a bus de 7-bits",
    "author": "gut-mart",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "2004f771-cc7e-4e98-8b5d-01278f8b1ce8",
          "type": "basic.output",
          "data": {
            "name": "o",
            "range": "[6:0]",
        ...
        {
          "id": "ac1eacee-922f-4618-b5d7-0cdb18696b22",
          "type": "basic.input",
          "data": {
            "name": "i0",
            "range": "[2:0]",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "<h1>Agregador buses(4+3)<h1>",
            "readonly": true
          },
          "position": {
            "x": 416,
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "2004f771-cc7e-4e98-8b5d-01278f8b1ce8",
            "port": "in"
          },
          "size": 7
        },
        {
          "source": {
            "block": "ac1eacee-922f-4618-b5d7-0cdb18696b22",
            "port": "out"
          },
          "target": {
            "block": "557af22b-775a-490b-b94f-567c59ab4aed",
