{
  "version": "1.2",
  "package": {
    "name": "Agregador buses(2+1) bits",
    "version": "0.1",
    "description": "Agregador de buses de 2-bit y 1-bits a bus de 3-bits",
    "author": "gut-mart",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "28574343-6a0e-4dfc-b886-415c73a6c1b0",
          "type": "basic.input",
          "data": {
            "name": "i1",
            "range": "[1:0]",
        ...
        {
          "id": "6927e043-04fc-4608-b8c5-bc4d93bb1364",
          "type": "basic.output",
          "data": {
            "name": "o",
            "range": "[2:0]",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "<h1>Agregador buses(2+1)<h1>",
            "readonly": true
          },
          "position": {
            "x": 408,
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "28574343-6a0e-4dfc-b886-415c73a6c1b0",
            "port": "out"
          },
          "target": {
            "block": "557af22b-775a-490b-b94f-567c59ab4aed",
        ...
        },
        {
          ...
          "target": {
            "block": "6927e043-04fc-4608-b8c5-bc4d93bb1364",
            "port": "in"
          },
          "size": 3
        }
