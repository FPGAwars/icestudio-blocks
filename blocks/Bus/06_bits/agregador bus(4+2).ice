{
  "version": "1.2",
  "package": {
    "name": "Agregador buses(4+2) bits",
    "version": "0.1",
    "description": "Agregador de buses de 4-bits y 2-bits a bus de 6-bits",
    "author": "gut-mart",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "d94643c4-bbe3-4e1e-a9cf-944124fce7bd",
          "type": "basic.output",
          "data": {
            "name": "o",
            "range": "[5:0]",
        ...
        {
          "id": "73263e35-b8d9-40e8-adf8-58271b7742a2",
          "type": "basic.input",
          "data": {
            "name": "i0",
            "range": "[1:0]",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "<h1>Agregador buses(4+2)<h1>",
            "readonly": true
          },
          "position": {
            "x": 408,
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "d94643c4-bbe3-4e1e-a9cf-944124fce7bd",
            "port": "in"
          },
          "size": 6
        },
        {
          "source": {
            "block": "73263e35-b8d9-40e8-adf8-58271b7742a2",
            "port": "out"
          },
          "target": {
            "block": "557af22b-775a-490b-b94f-567c59ab4aed",
