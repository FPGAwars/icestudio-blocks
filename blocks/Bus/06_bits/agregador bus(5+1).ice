{
  "version": "1.2",
  "package": {
    "name": "Agregador buses(5+1) bits",
    "version": "0.1",
    "description": "Agregador de buses de 5-bits y 1-bit a bus de 6-bits",
    "author": "gut-mart",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "a52897ac-2eb2-46ef-8c7d-18aceb6111cf",
          "type": "basic.output",
          "data": {
            "name": "o",
            "range": "[5:0]",
        ...
        {
          "id": "193a1bc8-66c9-4290-9e74-3e17cccc2670",
          "type": "basic.input",
          "data": {
            "name": "i0",
            "range": "[0:0]",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "<h1>Agregador buses(5+1)<h1>",
            "readonly": true
          },
          "position": {
            "x": 400,
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "a52897ac-2eb2-46ef-8c7d-18aceb6111cf",
            "port": "in"
          },
          "size": 6
        },
        {
          "source": {
            "block": "193a1bc8-66c9-4290-9e74-3e17cccc2670",
            "port": "out"
          },
          "target": {
            "block": "557af22b-775a-490b-b94f-567c59ab4aed",
