  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "96f23a73-a705-4331-a185-5aaff72adf7d",
          "type": "basic.input",
          "data": {
            "name": "i",
            "range": "[5:0]",
        ...
        {
          "id": "ccd4b4a7-4fb6-455a-affc-307b3e4a3b68",
          "type": "basic.output",
          "data": {
            "name": "o0",
            "range": "[1:0]",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "ccd4b4a7-4fb6-455a-affc-307b3e4a3b68",
            "port": "in"
          },
          "size": 2
        },
        {
          "source": {
            "block": "96f23a73-a705-4331-a185-5aaff72adf7d",
            "port": "out"
          },
          "target": {
            "block": "dcd8567f-2ff9-4aac-946b-b898f723fd43",
