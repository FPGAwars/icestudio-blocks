  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "bfd81cf4-e8e9-4d22-b5a1-3bcd6d115e04",
          "type": "basic.input",
          "data": {
            "name": "i",
            "range": "[8:0]",
        ...
        {
          "id": "76d1e92a-6e62-4eb8-be35-2bd11a457446",
          "type": "basic.output",
          "data": {
            "name": "o0",
            "range": "[5:0]",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "76d1e92a-6e62-4eb8-be35-2bd11a457446",
            "port": "in"
          },
          "size": 6
        },
        {
          "source": {
            "block": "bfd81cf4-e8e9-4d22-b5a1-3bcd6d115e04",
            "port": "out"
          },
          "target": {
            "block": "dcd8567f-2ff9-4aac-946b-b898f723fd43",
