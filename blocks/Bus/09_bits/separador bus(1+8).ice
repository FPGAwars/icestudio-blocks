{
  "version": "1.2",
  "package": {
    "name": "separador bus(1+8)",
    "version": "0.1",
    "description": "Separador bus(1+8)",
    "author": "gut-mart",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "380867d8-80aa-4558-bfc5-a714b611d243",
          "type": "basic.input",
          "data": {
            "name": "i",
            "range": "[8:0]",
        ...
        {
          "id": "fa353adb-146f-4ac3-ab8c-c0af709c0bcb",
          "type": "basic.output",
          "data": {
            "name": "o0",
            "range": "[7:0]",
      ...
      "wires": [
        {
          "source": {
            "block": "380867d8-80aa-4558-bfc5-a714b611d243",
            "port": "out"
          },
          "target": {
        ...
        },
        {
          ...
          "target": {
            "block": "fa353adb-146f-4ac3-ab8c-c0af709c0bcb",
            "port": "in"
          },
          "size": 8
        }
