{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "b1ab3825-7d6f-4385-83b9-d9377836bcf0",
          "type": "basic.input",
          "data": {
            "name": "i1",
            "range": "[4:0]",
        ...
        {
          "id": "c6585278-066b-4a3d-9259-aef85737d41f",
          "type": "basic.output",
          "data": {
            "name": "o",
            "range": "[8:0]",
        ...
        {
          "id": "eb3a7a38-072f-4dbd-8d7a-270e0f37fd9a",
          "type": "basic.input",
          "data": {
            "name": "i0",
            "range": "[3:0]",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "<h1>Agregador buses(5+4)<h1>",
            "readonly": true
          },
          "position": {
            "x": 416,
      ...
      "wires": [
        {
          "source": {
            "block": "b1ab3825-7d6f-4385-83b9-d9377836bcf0",
            "port": "out"
          },
          "target": {
        ...
        },
        {
          ...
          "target": {
            "block": "c6585278-066b-4a3d-9259-aef85737d41f",
            "port": "in"
          },
          "size": 9
        },
        {
          "source": {
            "block": "eb3a7a38-072f-4dbd-8d7a-270e0f37fd9a",
            "port": "out"
          },
          "target": {
            "block": "557af22b-775a-490b-b94f-567c59ab4aed",
