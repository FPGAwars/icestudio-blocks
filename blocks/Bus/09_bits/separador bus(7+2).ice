{
  "version": "1.2",
  "package": {
    "name": "separador bus(7+2)",
    "version": "0.1",
    "description": "Separador bus(7+2)",
    "author": "gut-mart",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "ee94bfbe-4b07-45ba-8778-f72e927c77bb",
          "type": "basic.input",
          "data": {
            "name": "i",
            "range": "[8:0]",
        ...
        {
          "id": "e6597247-77e4-4949-9117-c81f4f8b5fa6",
          "type": "basic.output",
          "data": {
            "name": "o0",
            "range": "[1:0]",
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "ee94bfbe-4b07-45ba-8778-f72e927c77bb",
            "port": "out"
          },
          "target": {
            "block": "dcd8567f-2ff9-4aac-946b-b898f723fd43",
        ...
        },
        {
          ...
          "target": {
            "block": "e6597247-77e4-4949-9117-c81f4f8b5fa6",
            "port": "in"
          },
          "size": 2
        }
