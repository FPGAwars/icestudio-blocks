{
  "version": "1.2",
  "package": {
    "name": "separador bus(8+1)",
    "version": "0.1",
    "description": "Separador bus(8+1)",
    "author": "gut-mart",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "6cd13edc-41c4-4794-93b6-d852849f8276",
          "type": "basic.output",
          "data": {
            "name": "o1",
            "range": "[7:0]",
        ...
        {
          "id": "aff599c3-97dc-40fe-939c-8d01cb8effdd",
          "type": "basic.input",
          "data": {
            "name": "i",
            "range": "[8:0]",
        ...
        {
          "id": "48ecba43-6e7d-416f-9ea6-222f7b6d9c30",
          "type": "basic.output",
          "data": {
            "name": "o0",
            "range": "[0:0]",
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "6cd13edc-41c4-4794-93b6-d852849f8276",
            "port": "in"
          },
          "size": 8
        },
        {
          ...
          "target": {
            "block": "48ecba43-6e7d-416f-9ea6-222f7b6d9c30",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "aff599c3-97dc-40fe-939c-8d01cb8effdd",
            "port": "out"
          },
          "target": {
            "block": "dcd8567f-2ff9-4aac-946b-b898f723fd43",
