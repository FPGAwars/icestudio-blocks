{
  "version": "1.2",
  "package": {
    "name": "separador bus(4+5)",
    "version": "0.1",
    "description": "Separador bus(4+5)",
    "author": "gut-mart",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "3c639afa-9cac-4474-8d34-b40967eaf367",
          "type": "basic.input",
          "data": {
            "name": "i",
            "range": "[8:0]",
        ...
        {
          "id": "9bbe2090-c827-40a4-b7be-6153f3f65c90",
          "type": "basic.output",
          "data": {
            "name": "o0",
            "range": "[4:0]",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "9bbe2090-c827-40a4-b7be-6153f3f65c90",
            "port": "in"
          },
          "size": 5
        },
        {
          "source": {
            "block": "3c639afa-9cac-4474-8d34-b40967eaf367",
            "port": "out"
          },
          "target": {
            "block": "dcd8567f-2ff9-4aac-946b-b898f723fd43",
