{
  "version": "1.2",
  "package": {
    "name": "Agregador buses(3+5) bits",
    "version": "0.1",
    "description": "Agregador de buses de 3-bits y 5-bits a bus de 8-bits",
    "author": "gut-mart",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "0b3a8325-44e8-4352-9a10-1fc168eb3a9c",
          "type": "basic.output",
          "data": {
            "name": "o",
            "range": "[7:0]",
        ...
        {
          "id": "6f6bbc7a-a596-4816-8909-9a10262afa5a",
          "type": "basic.input",
          "data": {
            "name": "i0",
            "range": "[4:0]",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "<h1>Agregador buses(3+5)<h1>",
            "readonly": true
          },
          "position": {
            "x": 408,
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "0b3a8325-44e8-4352-9a10-1fc168eb3a9c",
            "port": "in"
          },
          "size": 8
        },
        {
          "source": {
            "block": "6f6bbc7a-a596-4816-8909-9a10262afa5a",
            "port": "out"
          },
          "target": {
            "block": "557af22b-775a-490b-b94f-567c59ab4aed",
