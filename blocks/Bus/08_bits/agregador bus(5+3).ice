{
  "version": "1.2",
  "package": {
    "name": "Agregador buses(5+3) bits",
    "version": "0.1",
    "description": "Agregador de buses de 5-bits y 3-bits a bus de 8-bits",
    "author": "gut-mart",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "1403505c-1d1a-4ef9-a0c9-9f62c9ca1dfd",
          "type": "basic.output",
          "data": {
            "name": "o",
            "range": "[7:0]",
        ...
        {
          "id": "4e00bb4f-007b-4104-95ae-5dcf1c214fab",
          "type": "basic.input",
          "data": {
            "name": "i0",
            "range": "[2:0]",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "<h1>Agregador buses(5+3)<h1>",
            "readonly": true
          },
          "position": {
            "x": 416,
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "1403505c-1d1a-4ef9-a0c9-9f62c9ca1dfd",
            "port": "in"
          },
          "size": 8
        },
        {
          "source": {
            "block": "4e00bb4f-007b-4104-95ae-5dcf1c214fab",
            "port": "out"
          },
          "target": {
            "block": "557af22b-775a-490b-b94f-567c59ab4aed",
