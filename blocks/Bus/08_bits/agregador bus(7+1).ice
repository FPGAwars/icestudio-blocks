{
  "version": "1.2",
  "package": {
    "name": "Agregador buses(7+1) bits",
    "version": "0.1",
    "description": "Agregador de buses de 7-bits y 1-bits a bus de 8-bits",
    "author": "gut-mart",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "b6c18958-d9eb-49b5-a4f3-34da5b9f8400",
          "type": "basic.output",
          "data": {
            "name": "o",
            "range": "[7:0]",
        ...
        {
          "id": "5f5c5386-12c6-45d4-8e7b-8660b25b692f",
          "type": "basic.input",
          "data": {
            "name": "i0",
            "range": "[0:0]",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "<h1>Agregador buses(7+1)<h1>",
            "readonly": true
          },
          "position": {
            "x": 416,
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "b6c18958-d9eb-49b5-a4f3-34da5b9f8400",
            "port": "in"
          },
          "size": 8
        },
        {
          "source": {
            "block": "5f5c5386-12c6-45d4-8e7b-8660b25b692f",
            "port": "out"
          },
          "target": {
            "block": "557af22b-775a-490b-b94f-567c59ab4aed",
