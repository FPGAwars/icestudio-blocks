{
  "version": "1.2",
  "package": {
    "name": "Agregador buses(6+2) bits",
    "version": "0.1",
    "description": "Agregador de buses de 6-bits y 2-bits a bus de 8-bits",
    "author": "gut-mart",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "818786f2-ab64-4507-98fa-ab0c3044f3a7",
          "type": "basic.output",
          "data": {
            "name": "o",
            "range": "[7:0]",
        ...
        {
          "id": "347e61d9-018c-44d7-ae9d-d4817763c60d",
          "type": "basic.input",
          "data": {
            "name": "i0",
            "range": "[1:0]",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "<h1>Agregador buses(6+2)<h1>",
            "readonly": true
          },
          "position": {
            "x": 416,
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "347e61d9-018c-44d7-ae9d-d4817763c60d",
            "port": "out"
          },
          "target": {
            "block": "557af22b-775a-490b-b94f-567c59ab4aed",
        ...
        },
        {
          ...
          "target": {
            "block": "818786f2-ab64-4507-98fa-ab0c3044f3a7",
            "port": "in"
          },
          "size": 8
        }
