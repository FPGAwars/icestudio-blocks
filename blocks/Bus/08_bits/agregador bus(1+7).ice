  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "7f2edf0f-02ad-4738-98b4-12922e5f8899",
          "type": "basic.output",
          "data": {
            "name": "o",
            "range": "[7:0]",
        ...
        {
          "id": "c55e55e6-6292-44a4-b438-fc4fc5bfc103",
          "type": "basic.input",
          "data": {
            "name": "i0",
            "range": "[6:0]",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "<h1>Agregador buses(1+7)<h1>",
            "readonly": true
          },
          "position": {
            "x": 392,
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "c55e55e6-6292-44a4-b438-fc4fc5bfc103",
            "port": "out"
          },
          "target": {
            "block": "557af22b-775a-490b-b94f-567c59ab4aed",
        ...
        },
        {
          ...
          "target": {
            "block": "7f2edf0f-02ad-4738-98b4-12922e5f8899",
            "port": "in"
          },
          "size": 8
        }
