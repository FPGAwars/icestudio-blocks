  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "3a6d4151-302b-4bed-894b-2a96abc50e90",
          "type": "basic.input",
          "data": {
            "name": "i",
            "range": "[7:0]",
        ...
        {
          "id": "69fcfce2-2b63-4db9-9f5d-389d1d4261ad",
          "type": "basic.output",
          "data": {
            "name": "o0",
            "range": "[6:0]",
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "3a6d4151-302b-4bed-894b-2a96abc50e90",
            "port": "out"
          },
          "target": {
            "block": "dcd8567f-2ff9-4aac-946b-b898f723fd43",
        ...
        },
        {
          ...
          "target": {
            "block": "69fcfce2-2b63-4db9-9f5d-389d1d4261ad",
            "port": "in"
          },
          "size": 7
        }
