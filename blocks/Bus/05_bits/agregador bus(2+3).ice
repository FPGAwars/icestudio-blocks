{
  "version": "1.2",
  "package": {
    "name": "Agregador buses(2+3) bits",
    "version": "0,1",
    "description": "Agregador de buses de 2-bit y 3-bits a bus de 5-bits",
    "author": "gut-mart",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "1a6bed1d-e0ef-4490-8c93-71e1b3d9a09d",
          "type": "basic.output",
          "data": {
            "name": "out",
            "range": "[4:0]",
        ...
        {
          "id": "3ff3cb20-4ad4-4b59-ba2b-fea430ee495d",
          "type": "basic.input",
          "data": {
            "name": "i0",
            "range": "[2:0]",
        ...
        {
          "id": "e0e47671-b6a9-4971-ac01-90fc516efb47",
          "type": "basic.info",
          "data": {
            "info": "<h1>Agregador buses(2+3)<h1>",
            "readonly": true
          },
          "position": {
            "x": 288,
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "3ff3cb20-4ad4-4b59-ba2b-fea430ee495d",
            "port": "out"
          },
          "target": {
            "block": "817cafa8-c77f-4835-95a9-50f3e02375cf",
        ...
        },
        {
          ...
          "target": {
            "block": "1a6bed1d-e0ef-4490-8c93-71e1b3d9a09d",
            "port": "in"
          },
          "size": 5
        }
