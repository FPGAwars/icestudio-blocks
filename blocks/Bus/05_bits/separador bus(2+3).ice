{
  "version": "1.2",
  "package": {
    "name": "separador bus(2+3)",
    "version": "0.1",
    "description": "Separador bus(2+3)",
    "author": "gut-mart",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "07be57bb-c13e-4f91-af78-856b48b8bcbc",
          "type": "basic.input",
          "data": {
            "name": "i",
            "range": "[4:0]",
        ...
        {
          "id": "d8689f4c-372e-4322-8ed0-35acfe9d5706",
          "type": "basic.output",
          "data": {
            "name": "o0",
            "range": "[2:0]",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "d8689f4c-372e-4322-8ed0-35acfe9d5706",
            "port": "in"
          },
          "size": 3
        },
        {
          "source": {
            "block": "07be57bb-c13e-4f91-af78-856b48b8bcbc",
            "port": "out"
          },
          "target": {
            "block": "dcd8567f-2ff9-4aac-946b-b898f723fd43",
