{
  "version": "1.2",
  "package": {
    "name": "Agregador buses(3+2) bits",
    "version": "0.1",
    "description": "Agregador de buses de 3-bit y 2-bits a bus de 5-bits",
    "author": "gut-mart",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "263d6f1f-9c82-4a49-8e36-a642c8d55ac0",
          "type": "basic.output",
          "data": {
            "name": "o",
            "range": "[4:0]",
        ...
        {
          "id": "8ff07968-7132-48c6-a865-709444f1b411",
          "type": "basic.input",
          "data": {
            "name": "i0",
            "range": "[1:0]",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "<h1>Agregador buses(3+2)<h1>",
            "readonly": true
          },
          "position": {
            "x": 408,
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "8ff07968-7132-48c6-a865-709444f1b411",
            "port": "out"
          },
          "target": {
            "block": "557af22b-775a-490b-b94f-567c59ab4aed",
        ...
        },
        {
          ...
          "target": {
            "block": "263d6f1f-9c82-4a49-8e36-a642c8d55ac0",
            "port": "in"
          },
          "size": 5
        }
