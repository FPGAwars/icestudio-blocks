{
  "version": "1.2",
  "package": {
    "name": "separador bus(4+1)",
    "version": "0.1",
    "description": "Separador bus(4+1)",
    "author": "gut-mart",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "af8c7d64-d5bd-414b-83c5-560d0352e6b4",
          "type": "basic.input",
          "data": {
            "name": "i",
            "range": "[4:0]",
        ...
        {
          "id": "bb5b8c9e-f511-4e10-962f-cd885ec8407c",
          "type": "basic.output",
          "data": {
            "name": "o0",
            "range": "[0:0]",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "bb5b8c9e-f511-4e10-962f-cd885ec8407c",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "af8c7d64-d5bd-414b-83c5-560d0352e6b4",
            "port": "out"
          },
          "target": {
            "block": "dcd8567f-2ff9-4aac-946b-b898f723fd43",
