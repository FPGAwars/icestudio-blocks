{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "6ebd1b9c-7746-4f2e-b079-5dd9a1d0450f",
          "type": "basic.output",
          "data": {
            "name": "o",
            "range": "[7:0]",
        ...
        {
          "id": "af2c4761-0f62-48cb-9ead-d854c3ab44e9",
          "type": "basic.input",
          "data": {
            "name": "in",
            "range": "[7:0]",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "<h1> Puerta inversora bus(8bits).<h1>",
            "readonly": true
          },
          "position": {
            "x": 840,
        ...
        {
          "id": "54cbfd99-c310-44b4-a501-de6023b46dbe",
          "type": "basic.code",
          "data": {
            "code": "assign o=~in;",
            "params": [],
      ...
      "wires": [
        {
          "source": {
            "block": "af2c4761-0f62-48cb-9ead-d854c3ab44e9",
            "port": "out"
          },
          "target": {
            "block": "54cbfd99-c310-44b4-a501-de6023b46dbe",
            "port": "in"
          },
          "size": 8
        },
        {
          ...
          "target": {
            "block": "6ebd1b9c-7746-4f2e-b079-5dd9a1d0450f",
            "port": "in"
          },
          "size": 8
        }
