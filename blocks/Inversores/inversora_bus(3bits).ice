{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "6d0bbe0e-9a82-430f-acd0-e02a3c8904ee",
          "type": "basic.output",
          "data": {
            "name": "out",
            "range": "[2:0]",
        ...
        {
          "id": "55afee3c-730c-4ee4-af94-c88f43b1abb0",
          "type": "basic.input",
          "data": {
            "name": "in",
            "range": "[2:0]",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "<h1> Puerta inversora bus(3-bits).<h1>",
            "readonly": true
          },
          "position": {
            "x": 928,
        ...
        {
          "id": "3de3c715-2d59-4375-b691-267172c38252",
          "type": "basic.code",
          "data": {
            "code": "assign o=~in;",
            "params": [],
      ...
      "wires": [
        {
          "source": {
            "block": "3de3c715-2d59-4375-b691-267172c38252",
            "port": "o"
          },
          "target": {
            "block": "6d0bbe0e-9a82-430f-acd0-e02a3c8904ee",
            "port": "in"
          },
          "size": 3
        },
        {
          "source": {
            "block": "55afee3c-730c-4ee4-af94-c88f43b1abb0",
            "port": "out"
          },
          "target": {
            "block": "3de3c715-2d59-4375-b691-267172c38252",
