{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "9cfe4233-1f0a-4c6b-8b47-88c4fd2d9a00",
          "type": "basic.input",
          "data": {
            "name": "in",
            "range": "[6:0]",
        ...
        {
          "id": "aacb15e7-ed79-4b20-8fbc-db3309dfb76f",
          "type": "basic.output",
          "data": {
            "name": "o",
            "range": "[6:0]",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "<h1> Puerta inversora bus(7bits).<h1>",
            "readonly": true
          },
          "position": {
            "x": 912,
        ...
        {
          "id": "a93401a5-ad2a-4b03-bef0-6469cc82bb57",
          "type": "basic.code",
          "data": {
            "code": "assign o=~in;",
            "params": [],
      ...
      "wires": [
        {
          "source": {
            "block": "a93401a5-ad2a-4b03-bef0-6469cc82bb57",
            "port": "o"
          },
          "target": {
            "block": "aacb15e7-ed79-4b20-8fbc-db3309dfb76f",
            "port": "in"
          },
          "size": 7
        },
        {
          "source": {
            "block": "9cfe4233-1f0a-4c6b-8b47-88c4fd2d9a00",
            "port": "out"
          },
          "target": {
            "block": "a93401a5-ad2a-4b03-bef0-6469cc82bb57",
