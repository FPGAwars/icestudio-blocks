{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "39ed40a1-e88b-44dd-b1fa-055c419bd828",
          "type": "basic.output",
          "data": {
            "name": "o",
            "range": "[5:0]",
        ...
        {
          "id": "632bc9ba-6283-403d-b700-b0e03b7a2f19",
          "type": "basic.input",
          "data": {
            "name": "in",
            "range": "[5:0]",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "<h1> Puerta inversora bus(6bits).<h1>",
            "readonly": true
          },
          "position": {
            "x": 912,
        ...
        {
          "id": "8ff2df54-3d87-4778-8fef-5b980b55e599",
          "type": "basic.code",
          "data": {
            "code": "assign o=~in;",
            "params": [],
      ...
      "wires": [
        {
          "source": {
            "block": "632bc9ba-6283-403d-b700-b0e03b7a2f19",
            "port": "out"
          },
          "target": {
            "block": "8ff2df54-3d87-4778-8fef-5b980b55e599",
            "port": "in"
          },
          "size": 6
        },
        {
          ...
          "target": {
            "block": "39ed40a1-e88b-44dd-b1fa-055c419bd828",
            "port": "in"
          },
          "size": 6
        }
