{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "f702abda-c372-4c0a-8e49-c5f12d553a12",
          "type": "basic.input",
          "data": {
            "name": "in",
            "range": "[8:0]",
        ...
        {
          "id": "3317ca20-a241-4aaa-9d60-0c72f7108f2c",
          "type": "basic.output",
          "data": {
            "name": "o",
            "range": "[8:0]",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "<h1> Puerta inversora bus(9-bits).<h1>",
            "readonly": true
          },
          "position": {
            "x": 936,
        ...
        {
          "id": "85aff75e-bbba-48e8-958a-8abd8419c2f0",
          "type": "basic.code",
          "data": {
            "code": "assign o=~in;",
            "params": [],
      ...
      "wires": [
        {
          "source": {
            "block": "85aff75e-bbba-48e8-958a-8abd8419c2f0",
            "port": "o"
          },
          "target": {
            "block": "3317ca20-a241-4aaa-9d60-0c72f7108f2c",
            "port": "in"
          },
          "size": 9
        },
        {
          "source": {
            "block": "f702abda-c372-4c0a-8e49-c5f12d553a12",
            "port": "out"
          },
          "target": {
            "block": "85aff75e-bbba-48e8-958a-8abd8419c2f0",
