{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "32bf8254-d50c-449c-bbfb-fce03866312e",
          "type": "basic.input",
          "data": {
            "name": "in",
            "range": "[3:0]",
        ...
        {
          "id": "09e14e32-4c0b-40ac-98be-8c76a05eb783",
          "type": "basic.output",
          "data": {
            "name": "o",
            "range": "[3:0]",
        ...
        {
          "id": "46ef4872-cf1d-4770-9c1f-52188edf7435",
          "type": "basic.info",
          "data": {
            "info": "<H1>Bloque inversor bus 4 entradas<h1> ",
            "readonly": true
          },
          "position": {
            "x": 984,
        ...
        {
          "id": "de82fb33-8055-4a7f-9845-8713913e63cb",
          "type": "basic.code",
          "data": {
            "code": "assign o=~in;",
            "params": [],
      ...
      "wires": [
        {
          "source": {
            "block": "de82fb33-8055-4a7f-9845-8713913e63cb",
            "port": "o"
          },
          "target": {
            "block": "09e14e32-4c0b-40ac-98be-8c76a05eb783",
            "port": "in"
          },
          "size": 4
        },
        {
          "source": {
            "block": "32bf8254-d50c-449c-bbfb-fce03866312e",
            "port": "out"
          },
          "target": {
            "block": "de82fb33-8055-4a7f-9845-8713913e63cb",
