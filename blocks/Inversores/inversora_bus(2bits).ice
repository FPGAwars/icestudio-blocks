{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "4065d067-ae25-4c8a-ac99-bf3992e411bd",
          "type": "basic.input",
          "data": {
            "name": "in",
            "range": "[1:0]",
        ...
        {
          "id": "03f726cd-1db5-46bd-9cfd-5c73c289f9db",
          "type": "basic.output",
          "data": {
            "name": "out",
            "range": "[1:0]",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "<H1>Bloque inversor bus (2bits)<h1> ",
            "readonly": true
          },
          "position": {
            "x": 808,
        ...
        {
          "id": "093d989f-9141-4776-b13f-d63c03123ae0",
          "type": "basic.code",
          "data": {
            "code": "assign o=~in;",
            "params": [],
      ...
      "wires": [
        {
          "source": {
            "block": "4065d067-ae25-4c8a-ac99-bf3992e411bd",
            "port": "out"
          },
          "target": {
            "block": "093d989f-9141-4776-b13f-d63c03123ae0",
            "port": "in"
          },
          "size": 2
        },
        {
          ...
          "target": {
            "block": "03f726cd-1db5-46bd-9cfd-5c73c289f9db",
            "port": "in"
          },
          "size": 2
        }
