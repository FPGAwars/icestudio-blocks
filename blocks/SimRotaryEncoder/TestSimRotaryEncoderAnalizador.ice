{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "5fa116cd-9082-4806-a1cd-93b6659291fa",
          "type": "basic.output",
          "data": {
            "name": "",
            "pins": [
        ...
        {
          "id": "8bde7e10-e38c-4bb8-83af-aa5dd62b550c",
          "type": "basic.output",
          "data": {
            "name": "",
            "pins": [
        ...
        {
          "id": "34cbd7ab-ed5b-43bd-9c37-30d84561c6e9",
          "type": "basic.output",
          "data": {
            "name": "",
            "pins": [
        ...
        {
          "id": "ef62d425-a668-4063-b9cd-a02d5cc380c1",
          "type": "basic.output",
          "data": {
            "name": "",
            "pins": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Circuito de prueba del bloque SimRotaryEncoder.\n\nEl parámetro hz_wave es el periodo de onda cuadrada generada para los canales\nA, B, not A, not B.\n\nEl parámetro hz_gap es el periodo de desfase entre A/B, not A/not B. Para que este\ndesfasado 90º debe ser la mitad de hz_wave.\n\nGenera señales cuadradas con el mismo tiempo en 1 que en 0.\n\nkz_wave     | hz_gap<br>\n12000000    | 6000000 | 0.5 Hz<br>\n6000000     | 3000000 | 1 Hz<br> \n120000      | 60000   | 50 Hz<br>\n2400        | 1200    | 2.5 KHz<br>\n1200        | 600     | 5 KHz<br>\n\nA velocidades vajas lo podemos ver con los leds. A velocidades más altas\nnecesitamos un analizador lógico / osciloscipio.\n\nEl bloque y circuito de prueba está en el repositorio de bloques de <b>Obijuan</b>.\n\nhttps://github.com/FPGAwars/icestudio-blocks\n\n<b>Josep Montoliu i Sanahuja, 2018</b>",
            "readonly": true
          },
          "position": {
            "x": -496,
        ...
        {
          "id": "794cc964-303e-48a8-b535-af3e14e39c85",
          "type": "0e1d91aa30a6fa848831de69ac7c69c490107b10",
          "position": {
            "x": 400,
            "y": 248
          },
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "794cc964-303e-48a8-b535-af3e14e39c85",
        ...
        },
        {
          "source": {
            "block": "794cc964-303e-48a8-b535-af3e14e39c85",
            "port": "a6a648b7-561f-4812-b907-582943e7dbb0"
          },
          "target": {
            "block": "5fa116cd-9082-4806-a1cd-93b6659291fa",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "794cc964-303e-48a8-b535-af3e14e39c85",
            "port": "8ce02801-1836-4583-985b-743c6b82d454"
          },
          "target": {
            "block": "8bde7e10-e38c-4bb8-83af-aa5dd62b550c",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "794cc964-303e-48a8-b535-af3e14e39c85",
            "port": "b90b0492-e473-4c0c-90b9-410e7326b413"
          },
          "target": {
            "block": "34cbd7ab-ed5b-43bd-9c37-30d84561c6e9",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "794cc964-303e-48a8-b535-af3e14e39c85",
            "port": "81985790-1976-4f40-a0e1-fea80fe8fe1a"
          },
          "target": {
            "block": "ef62d425-a668-4063-b9cd-a02d5cc380c1",
            "port": "in"
          },
          "vertices": [
            {
  ...
  "dependencies": {
    "0e1d91aa30a6fa848831de69ac7c69c490107b10": {
      "package": {
      ...
      "design": {
        "graph": {
          "blocks": [
            {
              "id": "a6a648b7-561f-4812-b907-582943e7dbb0",
              "type": "basic.output",
              "data": {
                "name": "A"
              },
            ...
            {
              "id": "8ce02801-1836-4583-985b-743c6b82d454",
              "type": "basic.output",
              "data": {
                "name": "NA"
              },
            ...
            {
              "id": "b90b0492-e473-4c0c-90b9-410e7326b413",
              "type": "basic.output",
              "data": {
                "name": "B"
              },
            ...
            {
              "id": "81985790-1976-4f40-a0e1-fea80fe8fe1a",
              "type": "basic.output",
              "data": {
                "name": "NB"
              },
            ...
            {
              "id": "01e318e8-aac8-4b24-81de-f7dc144a1e87",
            ...
            {
              "id": "7f441499-a954-48f8-958b-577fdde5f35f",
              "type": "35f267d0df6ffcb7fc33753bc9df9cf083642cca",
              "position": {
                "x": 408,
                "y": -8
          ...
          "wires": [
            {
              ...
              "target": {
                "block": "a6a648b7-561f-4812-b907-582943e7dbb0",
                "port": "in"
              }
            },
            {
              ...
              "target": {
                "block": "01e318e8-aac8-4b24-81de-f7dc144a1e87",
            ...
            },
            {
              ...
              "target": {
                "block": "8ce02801-1836-4583-985b-743c6b82d454",
                "port": "in"
              }
            },
            {
            ...
            },
            {
              ...
              "target": {
                "block": "b90b0492-e473-4c0c-90b9-410e7326b413",
                "port": "in"
              },
              "vertices": []
            },
            {
              "source": {
                "block": "7f441499-a954-48f8-958b-577fdde5f35f",
                "port": "664caf9e-5f40-4df4-800a-b626af702e62"
              },
              "target": {
                "block": "81985790-1976-4f40-a0e1-fea80fe8fe1a",
                "port": "in"
              },
              "vertices": []
            },
